...
public class JDlgProdutoNovoIA extends javax.swing.JDialog {
    ...
    public OibProduto viewBean() {
        ...
        oibproduto.setIdusuarios(Util.strInt(jTxtCodigo.getText()));
        oibproduto.setNome(jTxtNome.getText());
        oibproduto.setApelido(jTxtApelido.getText());
        oibproduto.setCpf(jFmtCpf.getText());
        oibproduto.setDataNascimento(Util.strDate(jFmtDataDeNascimento.getText()));
        oibproduto.setSenha(jPwfSenha.getText());
        oibproduto.setNivel(jCboNivel.getSelectedIndex());
        oibproduto.setAtivo(jChbAtivo.isSelected() == true ? "S" : "N");
